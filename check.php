...
//если сигнатры сошлись, значит отправитель - pulpal , ниже можно писать код "что если оплата прошла успешно"
$idd=$array['UserData']; //переменная содержит идентификатор пользователя который мы указали в запросе email=821test
